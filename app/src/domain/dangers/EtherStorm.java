...
import static fastFeatures.PublicVariables.diagonalDown;
...
public class EtherStorm {
     ...
     public static void drawStorm(GraphicsContext graphics){
          graphics.drawImage(new Image("/DAO/images/terrains/storm.png"),xPosition[0],yPosition[0]);
          graphics.drawImage(new Image("/DAO/images/terrains/storm.png"),xPosition[1],yPosition[1]);
          graphics.drawImage(new Image("/DAO/images/terrains/storm.png"),xPosition[2],yPosition[2]);
