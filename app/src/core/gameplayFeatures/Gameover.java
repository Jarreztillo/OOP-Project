...
import static main.Roaster.animationTimer;
import static fastFeatures.PublicVariables.restoreAllCharacters;
import static fastFeatures.PublicVariables.window;
...
public class Gameover {
    ...
    private static void gameOverScreenConfig(){
        ...
        gameOverScene.getStylesheets().add(Gameover.class.getResource("/DAO/css/buttons.css").toExternalForm());
        canvas = new Canvas(1000, 800);
        gameOver=new ImageView("/DAO/images/gameOver/gameOverImage.png");
