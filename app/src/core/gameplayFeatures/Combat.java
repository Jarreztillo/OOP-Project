...
import static gameplayFeatures.Gameplay.*;
...
public class Combat {
    ...
    private static void setupWindow() {
        ...
        combatScene.getStylesheets().add(Combat.class.getResource("/DAO/css/buttons.css").toExternalForm());
    ...
    private static void dropConsumable() {
        dropConsumable = true;
            ...
            if (probabilities == 1) {
                ...
                inventory.getFirst().setImage("/DAO/images/consumables/vitalityPotion.png");
                ...
                inventory.get(1).setImage("/DAO/images/consumables/manaPotion.png");
                inventory.get(1).setDrawAtMap(true);
            }else{
                inventory.get(2).setX(enemy[0].getX());
                inventory.get(2).setY(enemy[0].getY());
                inventory.get(2).setImage("/DAO/images/consumables/shardAether.png");
    ...
    private static void drawAssets() {
        graphics.drawImage(new Image("/DAO/images/combatImages/combatBackground.png"), 0, 0);
        graphics.drawImage(new Image("/DAO/images/combatImages/combatSquare.png"), 0, 440);
    ...
    private static void drawSelector() {
        if (selectEnemyToAttack) {
            ...
            graphics.drawImage(new Image("/DAO/images/combatImages/selectEnemy.png"), enemiesXPosition, enemiesYPosition);
        }
    }
