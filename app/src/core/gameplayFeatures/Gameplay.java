...
import dangers.EtherStorm;
import generalClasses.Inventory;
import generalClasses.EnemyCharacter;
...
import static generalClasses.EnemyCharacter.randomQuantity;
...
public class Gameplay {
    ...
    */
    ...
    private static void setupWindow() {
        ...
        gameplayScene.getStylesheets().add(Gameplay.class.getResource("/DAO/css/buttons.css").toExternalForm());
    ...
    private static void showCreditsVideo(Stage window) {
        try {
            URL videoUrl = Gameplay.class.getResource("/DAO/videos/final.mp4");
    ...
    private static void drawGameplaySquares() {
        graphics.drawImage(new Image("/DAO/images/gameplayImages/statsSquare.png"), 680, 32);
        // Cuadro de las estadisticas.

        graphics.drawImage(new Image("/DAO/images/gameplayImages/dialogueSquare.png"), 32, 710);
        // Cuadro de los dialogos.

        graphics.drawImage(new Image("/DAO/images/gameplayImages/inventorySquare.png"), 680, 542);
    ...
    private static void drawConsumableToUse() {
        if (selectCharacterToConsumable){
            graphics.drawImage(new Image("/DAO/images/gameplayImages/selectCharacter.png"), squareX, squareY);
        }
    ...
    private static void rangeCollitionAllEnemies() {
        for(int i= 0; i< enemiSize; i++){
            for (int j = 0; j < enemi[i].length; j++){
                ...
                if (activateRange) {
                    if (time % 2 == 0) {
                        Image rangoSobrepuesto = new Image("/DAO/images/terrains/overRangeTerrain.png");
