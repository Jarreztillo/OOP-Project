...
import fastFeatures.Initializer;
...
public class Game extends Application {
    ...
    public void start(Stage window) {
        ...
        Image icono = new Image("/DAO/images/backgrounds/icono.jpg"); 
    ...
    private void showIntroVideo(Stage window) {
        try {
            URL videoUrl = getClass().getResource("/DAO/videos/inicio.mp4");
    ...
    private void settings() {
        ImageView wallpaper=new ImageView(getClass().getResource("/DAO/images/mainWallpaper/mainWallpaper.png").toExternalForm());
