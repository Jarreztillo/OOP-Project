...
import fastFeatures.SelectedCharacters;
import gameModes.Campaign;
import fastFeatures.AudioPlayer;
import fastFeatures.PublicVariables;
...
import static fastFeatures.ButtonManager.*;
import static fastFeatures.LabelManager.*;
import static fastFeatures.PublicVariables.*;
...
public class Roaster {
    ...
    private static String[] numberImages = {"/DAO/images/roasterImages/someNumbers/first.png", "/DAO/images/roasterImages/someNumbers/second.png", "/DAO/images/roasterImages/someNumbers/third.png", "/DAO/images/roasterImages/someNumbers/fourth.png", "/DAO/images/roasterImages/someNumbers/fifth.png"};
    ...
    private static void setupWindow() {
        ...
        roasterScene.getStylesheets().add(Roaster.class.getResource("/DAO/css/buttons.css").toExternalForm());
    ...
    private static void drawBackgroundAndSquares() {
        graphics.drawImage(new Image("/DAO/images/backgrounds/background.png"), 0, 0);
        graphics.drawImage(new Image("/DAO/images/roasterImages/interfaceSquares/characterSelector.png"), 8, 8);
        graphics.drawImage(new Image("/DAO/images/roasterImages/interfaceSquares/characterData.png"), 702, 8);

    }

    private static void drawCharacters() {
        graphics.drawImage(new Image("/DAO/images/frontCharacters/closerDraven.png"), first, first);
        graphics.drawImage(new Image("/DAO/images/frontCharacters/closerSirael.png"), first, second);
        graphics.drawImage(new Image("/DAO/images/frontCharacters/closerHobgrou.png"), first, third);
        graphics.drawImage(new Image("/DAO/images/frontCharacters/closerDrekker.png"), first, fourth);

        graphics.drawImage(new Image("/DAO/images/frontCharacters/closerCintya.png"), second, first);
        graphics.drawImage(new Image("/DAO/images/frontCharacters/closerLyrasa.png"), second, second);
        graphics.drawImage(new Image("/DAO/images/frontCharacters/closerGroshta.png"), second, third);
        graphics.drawImage(new Image("/DAO/images/frontCharacters/closerGrisha.png"), second, fourth);

        graphics.drawImage(new Image("/DAO/images/frontCharacters/closerJax.png"), third, first);
        graphics.drawImage(new Image("/DAO/images/frontCharacters/closerXaviru.png"), third, second);
        graphics.drawImage(new Image("/DAO/images/frontCharacters/closerGlobius.png"), third, third);
        graphics.drawImage(new Image("/DAO/images/frontCharacters/closerZorak.png"), third, fourth);

        graphics.drawImage(new Image("/DAO/images/frontCharacters/closerLina.png"), fourth, first);
        graphics.drawImage(new Image("/DAO/images/frontCharacters/closerHeloro.png"), fourth, second);
        graphics.drawImage(new Image("/DAO/images/frontCharacters/closerHobag.png"), fourth, third);
        graphics.drawImage(new Image("/DAO/images/frontCharacters/closerGoldan.png"), fourth, fourth);
        graphics.drawImage(new Image("/DAO/images/frontCharacters/closerAzely.png"), fourth, fifth);

        graphics.drawImage(new Image("/DAO/images/frontCharacters/closerAlessandra.png"), fifth, first);
        graphics.drawImage(new Image("/DAO/images/frontCharacters/closerLyffa.png"), fifth, second);
        graphics.drawImage(new Image("/DAO/images/frontCharacters/closerHiglob.png"), fifth, third);
        graphics.drawImage(new Image("/DAO/images/frontCharacters/closerGortana.png"), fifth, fourth);
        graphics.drawImage(new Image("/DAO/images/frontCharacters/closerShira.png"), fifth, fifth);
    }


    private static void drawSelectionSquare() {
        graphics.drawImage(new Image("/DAO/images/roasterImages/selectionHexagons/selectSquare.png"), col, row);
    }
    ...
    private static void drawCharactersData() {
        ...
        switch (col) {
            case first:
                switch (row) {
                    case first:
                        graphics.drawImage(new Image("/DAO/images/characterFaces/dravenFace.png"), 740, 20);
                        ...
                        break;
                    case second:
                        graphics.drawImage(new Image("/DAO/images/characterFaces/siraelFace.png"), 740, 20);
                        ...
                        break;
                    case third:
                        graphics.drawImage(new Image("/DAO/images/characterFaces/hobgrouFace.png"), 740, 20);
                        ...
                        break;
                    case fourth:
                        graphics.drawImage(new Image("/DAO/images/characterFaces/drekkerFace.png"), 740, 20);
            ...
            case second:
                switch (row) {
                    case first:
                        graphics.drawImage(new Image("/DAO/images/characterFaces/cintyaFace.png"), 740, 20);
                    ...
                    case second:
                        graphics.drawImage(new Image("/DAO/images/characterFaces/lyrasaFace.png"), 740, 20);
                        ...
                        break;
                    case third:
                        graphics.drawImage(new Image("/DAO/images/characterFaces/groshtaFace.png"), 740, 20);
                        ...
                        break;
                    case fourth:
                        graphics.drawImage(new Image("/DAO/images/characterFaces/grishaFace.png"), 740, 20);
            ...
            case third:
                switch (row) {
                    case first:
                        graphics.drawImage(new Image("/DAO/images/characterFaces/jaxFace.png"), 740, 20);
                    ...
                    case second:
                        graphics.drawImage(new Image("/DAO/images/characterFaces/xaviruFace.png"), 740, 20);
                        ...
                        break;
                    case third:
                        graphics.drawImage(new Image("/DAO/images/characterFaces/globiusFace.png"), 740, 20);
                        ...
                        break;
                    case fourth:
                        graphics.drawImage(new Image("/DAO/images/characterFaces/zorakFace.png"), 740, 20);
            ...
            case fourth:
                switch (row) {
                    case first:
                        graphics.drawImage(new Image("/DAO/images/characterFaces/linaFace.png"), 740, 20);
                    ...
                    case second:
                        graphics.drawImage(new Image("/DAO/images/characterFaces/heloroFace.png"), 740, 20);
                        ...
                        break;
                    case third:
                        graphics.drawImage(new Image("/DAO/images/characterFaces/hobagFace.png"), 740, 20);
                        ...
                        break;
                    case fourth:
                        graphics.drawImage(new Image("/DAO/images/characterFaces/goldanFace.png"), 740, 20);
                        ...
                        break;
                        case fifth:
                        graphics.drawImage(new Image("/DAO/images/characterFaces/azeliFace.png"), 740, 20);
            ...
            case fifth:
                switch (row) {
                    case first:
                        graphics.drawImage(new Image("/DAO/images/characterFaces/alessandraFace.png"), 740, 20);
                    ...
                    case second:
                        graphics.drawImage(new Image("/DAO/images/characterFaces/lyffaFace.png"), 740, 20);
                        ...
                        break;
                    case third:
                        graphics.drawImage(new Image("/DAO/images/characterFaces/higlobFace.png"), 740, 20);
                        ...
                        break;
                    case fourth:
                        graphics.drawImage(new Image("/DAO/images/characterFaces/gortonaFace.png"), 740, 20);
                    ...
                    case fifth:
                        labelInvisibilizer(mana);
                        graphics.drawImage(new Image("/DAO/images/characterFaces/shiraFace.png"), 740, 20);
    ...
    private static void allCharactersSelected() {
        if (selectedCharacters == 4) {
            graphics.drawImage(new Image("/DAO/images/roasterImages/interfaceSquares/messageSquare.png"), 5, 670);
