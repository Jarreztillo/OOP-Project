...
public class AudioPlayer {
    ...
    public static void initMediaPlayer() {
        sounds.put("mainMenu", new MediaPlayer(new Media(AudioPlayer.class.getResource("/DAO/audios/music/mainMenu.mp3").toString())));
        sounds.put("combatMusic", new MediaPlayer(new Media(AudioPlayer.class.getResource("/DAO/audios/music/combatMusic.mp3").toString())));
        sounds.put("gameOver", new MediaPlayer(new Media(AudioPlayer.class.getResource("/DAO/audios/music/gameOver.mp3").toString())));
        sounds.put("tileMap", new MediaPlayer(new Media(AudioPlayer.class.getResource("/DAO/audios/music/tileMap.mp3").toString())));
    ...
    public static void initAudioClips() {
          clips.put("selectedCharacter", new AudioClip(AudioPlayer.class.getResource("/DAO/audios/sound_effects/characterSelected.mp3").toString()));
          clips.put("buttonSound", new AudioClip(AudioPlayer.class.getResource("/DAO/audios/sound_effects/buttonMenu.mp3").toString()));
          clips.put("roasterButton", new AudioClip(AudioPlayer.class.getResource("/DAO/audios/sound_effects/roasterButtonActivated.mp3").toString()));
    }
